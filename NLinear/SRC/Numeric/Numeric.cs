...
namespace NLinear
{
        ...
        where T : IEquatable<T>
    {
        ...
        static public double ToDouble(T val)
        {
            return NumericConverter<T>.ToDouble(val);
        }

        static public T FromDouble(double d)
        {
            return NumericConverter<T>.FromDouble(d);
        }
        ...
        public static Numeric<T> operator *(Numeric<T> c1, double c)
        {
