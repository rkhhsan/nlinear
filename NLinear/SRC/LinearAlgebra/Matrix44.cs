...
namespace NLinear
{
        ...
        where T : IEquatable<T>
    {
        ...
        public Matrix44(Matrix33<T> r, Vec3<T> t, T unit)
        {
            x = new Numeric<T>[4][];
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        public void MultVecMatrix(Vec3<T> src, ref Vec3<T> dst)
        {
            Numeric<T> a, b, c, w;
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        public void MultDirMatrix(Vec3<T> src, ref Vec3<T> dst)
        {
            T a, b, c;
        ...
        public Matrix44<T> SetEulerAngles(Vec3<T> r, T unit)
        {
        ...
        public Matrix44<T> SetAxisAngle(Vec3<T> axis, T angle, T unit)
        {
            Vec3<T> vunit = axis.Normalized(unit);
        ...
        /// <returns></returns>
        public Matrix44<T> Rotate(Vec3<T> angle, T unit)
        {
            Numeric<T> cosRZ, sinRZ, cosRY, sinRY, cosRX, sinRX;
        ...
        /// Set matrix to scale by s
        /// </summary>
        public Matrix44<T> SetScale(Vec3<T> s, T unit)
        {
            x[0][0] = s[0];
            x[0][1] = Numeric<T>.Zero();
            x[0][2] = Numeric<T>.Zero();
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public Matrix44<T> Scale(Vec3<T> s)
        {
            x[0][0] *= s[0];
            x[0][1] *= s[0];
            x[0][2] *= s[0];
        ...
        public Matrix44<T> SetTranslation(Vec3<T> t, T unit)
        {
            x[0][0] = unit;
            x[0][1] = Numeric<T>.Zero();
            x[0][2] = Numeric<T>.Zero();
        ...
        {
            return new Vec3<T>(x[3][0], x[3][1], x[3][2]);
        }

        public Matrix44<T> Translate(Vec3<T> t)
        {
        ...
        public Matrix44<T> SetShear(Vec3<T> h, T unit)
        {
            x[0][0] = unit;
            x[0][1] = Numeric<T>.Zero();
            x[0][2] = Numeric<T>.Zero();
        ...
        public Matrix44<T> Shear(Vec3<T> h)
        {
            for (int i = 0; i < 4; i++)
            {
        ...
        public static Vec3<T> operator *(Vec3<T> v, Matrix44<T> m)
        {
