...
namespace NLinear
{
        ...
        where T : IEquatable<T>
    {
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        public static T operator ^(Vec2<T> c1, Vec2<T> c2)
        {
            return c1.Dot(c2);
        }
        ...
        /// <param name="c2"></param>
        /// <returns></returns>
        public static Vec2<T> operator +(Vec2<T> c1, Vec2<T> c2)
        {
            Vec2<T> v = new Vec2<T>();
        ...
        /// <param name="c2"></param>
        /// <returns></returns>
        public static Vec2<T> operator -(Vec2<T> c1)
        {
            Vec2<T> v = new Vec2<T>();
        ...
        /// <param name="c2"></param>
        /// <returns></returns>
        public static Vec2<T> operator *(Vec2<T> c1, T c)
        {
            Vec2<T> v = new Vec2<T>();
        ...
        /// <param name="c2"></param>
        /// <returns></returns>
        public static Vec2<T> operator *(T c, Vec2<T> c1)
        {
            Vec2<T> v = new Vec2<T>();
        ...
        /// </summary>
        /// <returns></returns>
        public Vec2<T> Normalize(T unit)
        {
            T l = Length(unit);
        ...
        /// </summary>
        /// <returns></returns>
        public Vec2<T> Normalized(T unit)
        {
            T l = Length(unit);
            ...
            if (numL.Equals(Numeric<T>.Zero()))
                return new Vec2<T>(Numeric<T>.Zero());

            return new Vec2<T>(x / l, y / l);
        }
        ...
        private static bool Equals(ref Vec2<T> v1, ref Vec2<T> v2)
        {
            return EqualityComparer<T>.Default.Equals(v1.X, v2.X)
                && EqualityComparer<T>.Default.Equals(v1.Y, v2.Y);
        }
