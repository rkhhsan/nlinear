...
namespace NLinear
{
        ...
        where T : IEquatable<T>
    {
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        public void MultVecMatrix(Vec2<T> src, ref Vec2<T> dst)
        {
            Numeric<T> a, b, w;
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        public void MultDirMatrix(Vec2<T> src, ref Vec2<T> dst)
        {
            Numeric<T> a, b;
        ...
        /// <param name="v"></param>
        /// <param name="m"></param>
        public static Vec3<T> operator *(Vec3<T> v, Matrix33<T> m)
        {
        ...
        /// Set matrix to scale by s
        /// </summary>
        public Matrix33<T> SetScale(Vec2<T> s, T unit)
        {
            x[0][0] = s[0];
            x[0][1] = Numeric<T>.Zero();
            x[0][2] = Numeric<T>.Zero();
        ...
        /// Set matrix to scale by s
        /// </summary>
        public Matrix33<T> Scale(Vec2<T> s)
        {
            x[0][0] *= s[0];
            x[0][1] *= s[0];
            x[0][2] *= s[0];
        ...
        /// </summary>
        public Matrix33<T> SetTranslation(Vec2<T> t, T unit)
        {
            x[0][0] = unit;
            x[0][1] = Numeric<T>.Zero();
            x[0][2] = Numeric<T>.Zero();
        ...
        Translation()
        {
            return new Vec2<T>(x[2][0], x[2][1]);
        }

        /// <summary>
        /// translate by t
        /// </summary>
        public Matrix33<T> Translate(Vec2<T> t)
        {
        ...
        public Matrix33<T> SetShear(Vec2<T> h, T unit)
        {
            x[0][0] = unit;
            x[0][1] = h[1];
            x[0][2] = Numeric<T>.Zero();
